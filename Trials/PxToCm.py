...
# GERÇEK iç köşe pixel koordinatını buraya gir
# (alt cetvelin üst iç kenarı) ∩ (sağ cetvelin sol iç kenarı)
MANUAL_ORIGIN_PX = (3165, 2395)
...
def detect_red_points_near_blue(image, blue_mask):
    ...
    # Mavi annotation civarını genişlet
...
def main():
    ...
    red_points_px, red_mask_all, red_mask_kept, blue_support = detect_red_points_near_blue(
        img, blue_mask
    )
    ...
    print("Detected points with manual origin:")
    ...
    out_vis = os.path.join(OUTPUT_DIR, "manual_origin_debug.png")
